...
public class MenuTest {
	...
	public void displays_a_list_of_menu_options_and_prompts_user_to_make_a_choice() {
		...
		String expected =
				System.lineSeparator() + "1) " + options[0].toString() +
				System.lineSeparator() + "2) " + options[1].toString() +
				System.lineSeparator() + "3) " + options[2].toString() +
	...
	public void redisplays_menu_if_user_does_not_choose_valid_option() {
		Object[] options = new Object[] { "Larry", "Curly", "Moe", "Joe" };
		...
		String menuDisplay =
				...
				System.lineSeparator() + "2) " + options[1].toString() +
				System.lineSeparator() + "3) " + options[2].toString() +
				System.lineSeparator() + "4) " + options[3].toString() +
				System.lineSeparator() + System.lineSeparator() +"Please choose an option >>> ";

		String expected =
				menuDisplay +
				System.lineSeparator() + "*** 5 is not a valid option ***" +
	...
	public void redisplays_menu_if_user_chooses_option_less_than_1() {
		...
		String expected =
				menuDisplay +
				System.lineSeparator() + "*** 0 is not a valid option ***" +
				System.lineSeparator() +
				System.lineSeparator() +
				menuDisplay;
	...
	public void redisplays_menu_if_user_enters_garbage() {
		...
		String expected = menuDisplay +
				System.lineSeparator() + "*** Mickey Mouse is not a valid option ***" +
				System.lineSeparator() +
				System.lineSeparator() +
				menuDisplay;
